...
#chat-input-area button:hover {
  background-color: #F1C40F; /* Un poco más oscuro al pasar el mouse */
}
#chat-container {
  position: fixed;
  bottom: 0;
  ...
  overflow: hidden; /* Para asegurarse de que los bordes internos respeten el border-radius */
  font-family: 'Arial', sans-serif; /* o cualquier otra tipografía que prefieras */
}

#chat-header {
  background-color: #FFDB58; /* Un amarillo claro, representativo del color del grano de maíz */
...
#chat-messages {
  ...
  overflow-y: auto; /* Hace que los mensajes sean deslizables */
  border-bottom: 1px solid #ccc; /* Línea opcional entre mensajes y área de entrada */
  padding: 10px;
}

#chat-header button {
  background-color: #F1C40F; /* Un amarillo más oscuro para elementos interactivos */
  border: none;
  color: white; 
  border-radius: 50%;
  width: 30px;
  height: 30px;
  text-align: center;
  line-height: 30px; /* Centra el guion "-" verticalmente */
  cursor: pointer;
}
#chat-messages {
  background-color: #FAFAD2; /* Un color claro, casi blanco, para el área de mensajes */
  color: #333;
  padding: 15px;
}
#chat-input-area {
  ...
  background-color: #228B22; /* Un verde representativo de las hojas de maíz */
  padding: 10px;
}
#chat-input-area button {
  background-color: #FFD700; /* Un amarillo más vivo para un elemento importante como el botón */
  color: white;
  border: none;
  padding: 10px;
  border-radius: 3px;
...
#chat-input-area {
  ...
  padding: 10px;
  display: flex; /* Mantiene el input y el botón en la misma fila */
  background-color: #f9f9f9; /* Color diferente para el área de entrada */
}
...
#messages {
  ...
  align-items: flex-start; /* Alinea inicialmente los mensajes a la izquierda */
}
...
.message {
  ...
  padding: 10px;
  border-radius: 20px;
  max-width: 70%; /* Evita que los mensajes ocupen todo el ancho */
}

.sent {
  align-self: flex-end; /* Alinea los mensajes enviados a la derecha */
  background-color: #efffde; /* Un verde claro para los mensajes enviados */
}
